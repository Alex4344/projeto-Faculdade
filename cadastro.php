...
<body >
    ...
    <div class="formulario">
        ...
        <form action="cadastro1.php" method="post">
            ...
            <input type="tel" name="telefone" minlength="11" maxlength="11" placeholder="Telefone"  required class="inputs">
            ...
            <input type="password" name="senha" placeholder="Senha" maxlength="25" minlength="10" 
